 ...
 * dynamic backlinks rendering, full sidebar widgets support, and Elementor Pro native overrides (Priority 10).
 *
...
// Support Elementor Pro Custom Footer Location Hook
if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'footer' ) ) :
	...
	<footer class="<?php echo esc_attr( $footer_class ); ?>">
		<div class="container">
			...
			<div class="footer-bottom" style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px; margin-top: 25px; flex-wrap: wrap; gap: 15px;">
				...
				<div class="monetization-credits" style="display: flex; gap: 15px; font-size: 11px; flex-wrap: wrap;">
					<?php
...
<?php endif; // Elementor Pro Footer Check ?>
